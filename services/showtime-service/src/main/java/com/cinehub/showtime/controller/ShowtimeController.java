...
public class ShowtimeController {
    ...
    // Endpoint: GET
    // /api/showtimes/by-theater?theaterId={id}&startDate=...&endDate=...
    ...
    public ResponseEntity<List<ShowtimeResponse>> getShowtimesByTheaterAndDate(
        ...
        List<ShowtimeResponse> responseList = showtimeService.getShowtimesByTheaterAndDate(theaterId, startDate,
                endDate);
        return ResponseEntity.ok(responseList);
    }
